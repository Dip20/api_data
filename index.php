...
// ............................................................................
 ...
 if(isset($_GET['apikey']) AND isset($_GET['apisecret']) AND isset($_GET['query']))
 {
   ...
   $query = $_GET['query'];
    ...
    // check for user apikey apisecret query should match with our database.
      ...
      if(mysqli_num_rows($sql)>0)
        {
          ...
          if ($apikey==$data['api_key'] AND $apisecret==$data['api_secret'])
          {
    ...
    }else
    {
      $obj = new stdClass();
      $obj->status = 0;
      $obj->error = "SERVER NOT RESPONDING!";
